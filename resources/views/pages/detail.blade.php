                        ...
                        <div class="col-lg-2" data-aos="zoom-in">
                            @auth
                                <form action="{{ route('detail-add', $product->id) }}" method="POST"
                                    ...
                                    @csrf
                                    <button type="submit" class="btn px-4 text-white btn-block mb-3" style="background-color: #722900; color: white">
                                        Add to Cart
                                    </button>
                                </form>
                            @else
                                <a href="{{ route('login') }}" class="btn px-4 text-white btn-block mb-3" style="background-color: #722900; color: white">
                                    Sign in to Add
                                </a>
                            @endauth
                        </div>
