                                ...
                                <form action="{{ route('dashboard-transaction-update', $transaction->id) }}" method="POST"
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <template v-if="status == 'SHIPPING'">
                                                    ...
                                                    <div class="col-md-2">
                                                        <button type="submit" class="btn btn-block mt-4" style="background-color: #722900; color: white">
                                                            Update Resi
                                                        </button>
                                                    </div>
                                                </template>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-12 text-right">
                                            <button type="submit" class="btn btn-lg mt-4" style="background-color: #722900; color: white">
                                                Save Now
                                            </button>
                                        </div>
                                    </div>
